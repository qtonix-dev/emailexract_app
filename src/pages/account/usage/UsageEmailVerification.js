...
export const UsageEmailVerification = (props) => {

    const [datas,setDatas] = useState(null);


    useEffect(() => {
        API.get(`/user/view/countsearch/${cookie.load('qtonixemailextractweb_userid')}/emailverification`)
        .then(response=>{
...
export default connect(mapStateToProps, mapDispatchToProps)(UsageEmailVerification)
