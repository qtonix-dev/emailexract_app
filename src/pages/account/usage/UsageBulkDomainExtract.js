...
export const UsageBulkDomainExtract = (props) => {

    const [datas,setDatas] = useState(null);


    useEffect(() => {
        API.get(`/user/view/countsearch/${cookie.load('qtonixemailextractweb_userid')}/bulkdomainextract`)
        .then(response=>{
...
export default connect(mapStateToProps, mapDispatchToProps)(UsageBulkDomainExtract)
