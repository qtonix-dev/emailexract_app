...
export const UsageEmailFinder = (props) => {

    const [datas,setDatas] = useState(null);


    useEffect(() => {
        API.get(`/user/view/countsearch/${cookie.load('qtonixemailextractweb_userid')}/emailfinder`)
        .then(response=>{
...
export default connect(mapStateToProps, mapDispatchToProps)(UsageEmailFinder)
